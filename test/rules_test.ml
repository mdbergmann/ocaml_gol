...
let living_less_than_2 _ =
  assert_equal false (is_alive 0 Alive);
  assert_equal false (is_alive 1 Alive)

let living_2_or_3_survives _ =
  assert_equal true (is_alive 2 Alive);
  assert_equal true (is_alive 3 Alive)

let living_more_than_3_dies _ =
  assert_equal false (is_alive 4 Alive);
  assert_equal false (is_alive 5 Alive)

let dead_3_becomes_alive _ =
  assert_equal true (is_alive 3 Dead)
